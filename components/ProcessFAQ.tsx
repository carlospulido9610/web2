...
const DETAILED_STEPS: ProcessStepDetail[] = [
  {
    ...
    subOptions: [
      { title: "I know what I want", content: "Send us a reference image or sketch. We provide clear, exact pricing across different price ranges." },
      { title: "I need guidance", content: "Browse our catalog or visit the showroom. Book an in-home assessment to refine your ideas." },
      { title: "Full design service", content: "For room transformations, we begin with a dedicated design phase, curation, and 3D rendering." }
    ]
  },
  {
    number: 2,
    title: 'Get a clear quote',
    description: 'We provide exact pricing instantly. No jargon, just standardized quotes including everything from materials to installation timelines.',
    listItems: ["Maximum possible size", "Customizations & add-ons", "Timeline & payment structure"]
  },
  {
    number: 3,
    title: 'Assessment & Deposit',
    description: "Book an in-home measurement visit. Confirm every detail on site before signing the final contract and placing your project deposit."
  },
  {
    number: 4,
    title: 'Production & Selections',
    description: "We build off-site (1-4 weeks). You finalize finish selections while we schedule your installation."
  },
  {
    number: 5,
    title: 'Installation',
    description: "Our professional team installs everything in 1-2 days. We ensure a clean, dust-free process and total floor protection."
  },
  {
    number: 6,
    title: 'Completion Walkthrough',
    description: "Final review of every detail. We explain the layout and connectivity before the final project sign-off."
  }
];
...
const FAQ_DATA: FAQCategory[] = [
  {
    ...
    title: 'Sales & Process',
    items: [
      { question: "How do I place an order?", answer: "Fill out the contact form. We will reach out the same day to discuss your project or schedule a showroom visit." },
      { question: "Do you offer free quotes?", answer: "Yes. Remote quotes via reference photos are free. In-home consultations require a $100 deposit, credited toward your project." }
    ]
  },
  {
    id: 'pricing',
    ...
    items: [
      { question: "How much is the deposit?", answer: "35% for projects over $4,000; 50% for projects under $4,000." },
      { question: "Payment methods?", answer: "Cash, check, Zelle, and credit cards." }
    ]
  }
];
        ...
        <div className="pt-24 border-t border-wood-200">
           ...
           <div className="flex flex-col lg:flex-row gap-12">
             ...
             <div className="lg:w-3/4">
               <div className="bg-white border border-wood-100 rounded-sm divide-y divide-wood-50">
